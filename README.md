...
Requires the [GitHub CLI](https://cli.github.com/) (`gh`). Replace `dynamo-ac99693-data-processing-and-etl`
with the repository you were assigned:

```bash
gh repo fork handshake-project-dynamo/dynamo-ac99693-data-processing-and-etl --clone
cd dynamo-ac99693-data-processing-and-etl
git checkout -b submission
#  ... build the task (see below) ...
git add -A && git commit -m "Task submission"
git push -u origin submission
gh pr create --repo handshake-project-dynamo/dynamo-ac99693-data-processing-and-etl --fill
```
